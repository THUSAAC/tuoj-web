...
router.post('/clariall', UserSrv.needLogin, ContestSrv.accessible, ClariCtrl.getAll);
router.post('/clarinew', UserSrv.needLogin, ContestSrv.accessible, ClariCtrl.getNew);
router.post('/clarisend', UserSrv.needLogin, ContestSrv.accessible, ClariCtrl.send);
